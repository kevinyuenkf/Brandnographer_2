<template>
  <div class="main-container">
    ...
    <div class="content-box">
      <p>You have successfully reset your password. You can now enjoy the online licensing services.</p>
      ...
      <div class="d-flex flex-wrap">
        ...
        <router-link class="no-dec" :to="{ name: ''}"><v-btn depressed class="o-btn-action rounded-pill mt-4" color="primary">Continue</v-btn></router-link>
      </div>
    </div>
  </div>
</template>
