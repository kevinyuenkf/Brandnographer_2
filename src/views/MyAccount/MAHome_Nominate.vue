      ...
      <div class="hidden-md-and-down header" >
        <div class="d-flex justify-center flex-column">
          <div class="d-flex justify-end mt-n2">
            <h5 class="ma-0 fw-400" style="color:white">User :  Hello1</h5>
          </div>
        ...
        <div v-if="record">
          ...
          <div class="o-tabs-card mt-6 mb-12" v-if="selected==0">
            <div class="top-header">
              ...
              <v-menu v-model="menu" :close-on-content-click="false" :nudge-left="menu_offset" offset-y offset-x>
                ...
                <div class="filter-menu">
                  ...
                  <v-select class="mt-6" :items="['a','b']" label="Application Type" outlined :menu-props="{offsetY: true}"></v-select>
                  <v-select class="mt-n2" :items="['All','Old to New','New to Old']" label="Submission Date" outlined :menu-props="{offsetY: true}"></v-select>
                  <v-select class="mt-n2 mb-2" :items="['a','b']" label="Status" outlined :menu-props="{offsetY: true}"></v-select>
                  <div class="d-flex justify-space-between">
            ...
            <div class="sec-header">
              ...
              <div class="hidden-md-and-down last-div"><h6>Form</h6></div>
            </div>
            <div class="content-container" v-for="(item,i) in ongoing_items" :key="i">
              <div class="content" >
                <div>
                  <div>{{item.type}}</div>
                  <div style="font-size:0.9375em;color:#7a7a7a">{{item.type_2}}</div>
                </div>
            ...
            <div class="px-8 pb-8">
              <div class="callout-div rounded py-4 align-start" v-if="!infoError">
                ...
                <p class="my-0 ml-4">The “Nomination of Reserve Licensee FEHB 266” Form will synchronize to the applicant account.</p>
              </div>
          ...
          <div class="o-tabs-card mt-6 mb-12" v-if="selected==2">
            ...
            <div class="sec-header">
              <h6>Application Type</h6>
              <h6 style="min-width:240px;">Reference No.</h6>
              <h6 class="hidden-md-and-down">Creation Date</h6>
            </div>
            <div class="content-container" v-for="(item,i) in draft_nom_items" :key="i">
              <div class="content" >
                <div>{{item.type}}</div>
                <div style="min-width:240px;" class="d-flex align-center">
                  <div>{{item.ref}}</div>
                  <v-btn icon color="primary" light class="hidden-lg-and-up">
                      <v-icon>mdi-chevron-right</v-icon>
                  </v-btn>
                ...
                <div class="hidden-md-and-down ">
                  <v-btn depressed class="o-btn-action rounded-pill mt-4 small ml-4" color="primary">Fill Form</v-btn>
...
export default {
  ...
  data: function () {
    return {
      ...
      ongoing_items:[
        {type:'Nominated Reserve Licensee 266',type_2:'llps1234_2345555-12122',date:'02-01-2021\n18:00',status:'Application Submitted'}
      ],
      ongoing_n_items:[
        {type:'Nominated Reserve Licensee 266',date:'02-01-2021\n18:00',status:'Application Submitted'}
      ],
      ...
      draft_nom_items:[
        {type:'Nominated Reserve Licensee 266',ref:'llps1234_2345555-12122',date:'30-06-2020\n18:00'},
      ],
      partOne: {
