<template>
  <div >
    ...
    <div class="part-3" v-if="partOne.selected==0 && !(partTwo[partOne.selected].selected==undefined) && partTwo[partOne.selected].selected!=2 && partThree[partOne.selected][partTwo[partOne.selected].selected].buttons.length>0">
    ...
    <div class="part-2" v-if="partOne.selected==0 && !(partTwo[partOne.selected].selected==undefined) && partTwo[partOne.selected].selected==2 && partThree[partOne.selected][partTwo[partOne.selected].selected].buttons.length>0">
      <div><h2>3. Licence Type</h2></div>
      <div>
        <v-btn-toggle v-model="partThree[partOne.selected][partTwo[partOne.selected].selected].selected" tile group>
          <v-btn v-for="(item,i) in partThree[partOne.selected][partTwo[partOne.selected].selected].buttons" :key=i>
...
export default {
  ...
  data: function () {
    return {
      ...
      selected:0,
      dialog: false,
      record:false, //  true: 6-2-1,  false: 6-1
    ...
    partTwo: [
      { //Parent is Applications
        buttons: ['New Licence', 'Licence Transfer','Application to Nomination of Reserve Licensee','Temporary Absence','Licence Amendment','Change Information'],
        selected: undefined
      },
      {
        //Parent is Renewal
