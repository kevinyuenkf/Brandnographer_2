<template>
  <div class="content-div content-div-1">
              ...
              <li>
                <div class="d-flex flex-column ">
                  ...
                  <div class="d-flex align-center mt-5 ">
                    ...
                    <v-tooltip right>
                      <template v-slot:activator="{ on, attrs }">
                        <v-icon class="tooltip-icon mt-1" color="secondary" dark v-bind="attrs" v-on="on">
                          mdi-help-circle
                        </v-icon>
                      </template>
                      <div>
    ...
    <div class="footer">
      ...
      <v-btn class="footer-btn b-primary"  :disabled="!agree" @click="$router.push({name:'RenewalInfoApplicant'})">{{$t('save_and_next')}}</v-btn>
    </div>
  </div>
</template>
