<template>
  <div class="content-div content-div-1">
        ...
        <v-form v-model="form.valid" >
            ...
            <div class="form-section ml-11 justify-start align-center pt-3">
               <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-baseline">
                      <v-combobox v-model="management_data.openingHrs[0].from[0]" class="ml-2 tf-multiple time margin-time-fix" :ref="'11_a_from_h'"  maxlength=2  @keyup="timeTFfocusNext('11_a_from_h','11_a_from_m')" :items="timebox.hours" outlined>
          ...
          <h5 class="mt-3 ml-7">b. Your weekly day-off is <span style="color:#7a7a7a" v-if="management_data.weeklyDayoff.days.length <= 2">(max 2 different days)</span><span class="red--text" v-if="management_data.weeklyDayoff.days.length > 2">(max 2 different days)</span></h5>
            ...
            <div class="form-section ml-11">
              <v-radio-group v-model="management_data.q12c" class="ml-2 mt-n3 mdq12c" row v-on:change="scrollToElement('mdq12c')">
                <v-radio class="row-radio" :label="'Yes'" :value="true"></v-radio>
                <v-radio class="row-radio ml-3" :label="'No'" :value="false"></v-radio>
              </v-radio-group>
            </div>

          <h5 v-show="management_data.q12c==true" class="mt-4 ml-14">Please provide information of nominee</h5>
          <div v-show="management_data.q12c==true" class="callout-div detail-box lg mt-6 mb-3 px-15 py-2">
            <div style="width:100%;">
              <div class="box-block" v-for="(item,i) in management_data.q12_c_detail" :key="i" style="width:100%;">
                <h5>Name</h5>
            ...
            <div class="form-div">
              <v-form v-model="form.valid">
                <div class="form-section ml-7">
                  ...
                  <v-radio-group v-model="management_data.q13" class="ml-6 mdq13" row v-on:change="scrollToElement('mdq13')">
                    <v-radio class="row-radio" :label="'Yes'" :value="true"></v-radio>
                    <v-radio class="row-radio ml-3" :label="'No'" :value="false"></v-radio>
                  </v-radio-group>
                </div>
                <div class="ml-14" v-if="management_data.q13==true">
                  ...
                  <v-tooltip right>
                    ...
                    <div class="ml-8">
                      ...
                      <div v-for="(item,i) in management_data.q13a" :key="i">
                        <h5>Name</h5>
                        <div class="form-section">
                          <v-text-field class="tf-half" v-model="item.chineseName" :rules="form.fullnameRules"  label="Chinese" outlined required></v-text-field>
                          <v-text-field class="tf-half" v-model="item.englishName" :rules="form.fullnameRules"  label="English" outlined required></v-text-field>
    ...
    <div class="footer">
      ...
      <v-btn class="footer-btn b-primary" :disabled="false" @click="$router.push({name:'RenewalModeOp'})">{{$t('save_and_next')}}</v-btn>
    </div>
  </div>
</template>
  ...
  data: function () {
    return {
      ...
      management_data:{
        ...
        q12c:false,
        q12_c_detail:[{chineseName:'',englishName:'',hkid:''}],
        q13:undefined,
        invitation:{option:false,email:'',sent:false},
        q13a:[{chineseName:'',englishName:'',hkid:'',contact:{tel:'',fax:'',agree:undefined}}]
      },
      region:{
        tc:['香港','九龍','新界'],
