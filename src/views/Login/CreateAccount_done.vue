<template>
  <div class="main-container">
    ...
    <div class="content-box">
      <p>The LLB will send the Password  to your correspondence address within the next 3 working days. Upon receipt of the Password letter, you can log in your account and create your own Password. You can enjoy the electronic service.</p>
